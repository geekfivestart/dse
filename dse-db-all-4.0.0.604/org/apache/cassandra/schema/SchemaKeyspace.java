...
public final class SchemaKeyspace {
   ...
   static Mutation.SimpleBuilder makeUpdateViewMutation(Mutation.SimpleBuilder builder, ViewMetadata oldView, ViewMetadata newView) {
      ...
      MapDifference<ByteBuffer, ColumnMetadata> columnDiff = Maps.difference(oldView.metadata.columns, newView.metadata.columns);
      ...
      MapDifference<ByteBuffer, DroppedColumn> droppedColumnDiff = Maps.difference(oldView.metadata.droppedColumns, oldView.metadata.droppedColumns);
      ...
      while(var9.hasNext()) {
         ...
         addDroppedColumnToSchemaMutation(newView.metadata, (DroppedColumn)newView.metadata.droppedColumns.get(name), builder);
      }
