...
public class BTreeRemoval {
    ...
    public static <V> Object[] remove(Object[] btree, Comparator<? super V> comparator, V elem) {
        ...
        int index = -1;
        Object elemToSwap = null;
        int lb = 0;
        Object[] node = btree;
        do {
            int keyEnd;
            int i;
            if ((i = Arrays.<Object>binarySearch(node, 0, keyEnd = BTree.getKeyEnd(node),
                    elem, (Comparator<Object>)comparator)) >= 0) {
        ...
        Object[] result = BTreeRemoval.removeFromLeaf(btree, index);
        if (elemToSwap != null) {
